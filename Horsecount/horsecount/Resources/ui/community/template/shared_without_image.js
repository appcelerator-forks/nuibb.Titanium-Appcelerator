...
/*
 * Get Shared Without Image Template
 */
Template.prototype.getSharedWithoutImageTemplate = function(onClickListener) {
	var plainTemplate = {
		properties : {
			backgroundColor : '#FFF',
			width : Ti.UI.SIZE,
...
/*
 * Set data to Shared Without Image Template
 */
Template.prototype.setDataToSharedWithoutImageTemplate = function(json) {
	return [{
